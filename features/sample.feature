...
Feature: Sample
    ...
    Scenario: Alice can add assets that she owns
        When I use the identity alice1
        And I add the following asset of type org.cc.patientdatanetwork.Procedure
            | assetId | owner           | procedureName |
    ...
    Scenario: Alice can update her assets
        When I use the identity alice1
        And I update the following asset of type org.cc.patientdatanetwork.Procedure
            | assetId | owner           | procedureName |
    ...
    Scenario: Alice can remove her assets
        When I use the identity alice1
        And I remove the following asset of type org.cc.patientdatanetwork.Procedure
            | assetId |
            | 1       |
        Then I should not have the following assets of type org.cc.patientdatanetwork.Procedure
            | assetId |
            | 1       |
    ...
    Scenario: Alice can submit a transaction for her assets
        ...
        Then I should have the following assets of type org.cc.patientdatanetwork.Procedure
            | assetId | owner           | procedureName |
            | 1       | alice@email.com | 50    |
        And I should have received the following event of type org.cc.patientdatanetwork.ItemShared
